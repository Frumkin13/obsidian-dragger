...
import { validateInPlaceDrop } from '../../model/container/drop-validation';
import { InsertionRuleRejectReason, InsertionSlotContext } from '../../model/container/insertion-rules';
import { getLineMap, LineMap } from '../parser/line-map';
import {
...
import { resolveLineNumberAtCoords } from '../../../infra/dom/probe/element-probe';
import { isPointInsideRenderedTableCell } from '../../../infra/dom/probe/table-guard';
import { ListDropTargetCalculator } from '../../../features/drag-operation/strategies/list-target-calculator';
import { clampTargetLineNumber } from '../../../shared/utils/math';
import { getPreviousNonEmptyLineNumber } from '../../model/container/container-policy';
import {
