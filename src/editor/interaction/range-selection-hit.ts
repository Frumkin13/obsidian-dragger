...
import { resolveLineNumberAtCoords, resolveLineNumberFromDomNodes } from '../core/dom-probe';
import { normalizeEmbedRoot } from '../core/embed-hit';
import { clampLineNumber } from '../core/line-number';
import { EMBED_BLOCK_SELECTOR } from '../core/selectors';
import { type RangeSelectionBoundary, resolveBlockBoundaryAtLine } from './range-selection-model';
