...
import { createDragPerfSession, DragPerfSession, logDragPerfSession } from '../state/perf-session';
import { getLineMap, setLineMapPerfRecorder } from '../../core/parser/line-map';
import { setDetectBlockPerfRecorder } from '../../core/block/block-factory';
