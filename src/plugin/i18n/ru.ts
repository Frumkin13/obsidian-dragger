...
export const ru: ZhCnStrings = {
    ...
    optionAlways: 'Всегда',
    optionHidden: 'Скрыт',
    dragSourceVisualStyle: 'Стиль выделения блока',
    dragSourceVisualStyleDesc: 'Общий стиль подсветки при перетаскивании',
    optionDragSourceVisualOutline: 'Только контур',
    optionDragSourceVisualSubtle: 'Лёгкая подсветка',
    optionDragSourceVisualFilled: 'Заливка',
    enableDragSourceHighlight: 'Подсветка перетаскиваемого блока',
    enableDragSourceHighlightDesc: 'Подсвечивать блок во время перетаскивания',
