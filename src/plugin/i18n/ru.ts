...
export const ru: ZhCnStrings = {
    ...
    requireMobileDragMode: 'Требовать режим перетаскивания на мобильном',
    requireMobileDragModeDesc: 'На мобильном блоки можно перетаскивать только после включения режима перетаскивания командой',
