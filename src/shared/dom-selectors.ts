...
export const CODEMIRROR_GUTTERS_AFTER_CLASS = 'cm-gutters-after';
export const CODEMIRROR_AFTER_GUTTERS_SELECTOR = `.${CODEMIRROR_GUTTERS_CLASS}.${CODEMIRROR_GUTTERS_AFTER_CLASS}`;
